...
--
-- Table structure for table `log_minutely`
--

DROP TABLE IF EXISTS `log_minutely`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `log_minutely` (
  `home_id` char(3) NOT NULL,
  `meter_id` char(3) NOT NULL,
  `year` smallint(6) NOT NULL,
  `jday` smallint(6) NOT NULL,
  `hour` tinyint(4) NOT NULL,
  `minute` tinyint(4) NOT NULL,
  `accum` float NOT NULL,
  `inst` float NOT NULL,
  PRIMARY KEY (`home_id`,`meter_id`,`year`,`jday`,`hour`,`minute`),
  KEY `by_hour_idx` (`home_id`,`meter_id`,`year`,`jday`,`hour`)
