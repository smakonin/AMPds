...
CREATE TABLE `meter` (
  ...
  `equipment_descr` varchar(64) DEFAULT NULL,
  `colour` varchar(8) DEFAULT NULL,
  `address_type` varchar(32) DEFAULT NULL,
  `address_main` varchar(32) DEFAULT NULL,
  `address_sub` varchar(32) DEFAULT NULL,
  `counter_units` varchar(8) DEFAULT NULL,
  `rate_units` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`home_id`,`meter_id`),
  KEY `by_home_idx` (`home_id`)
