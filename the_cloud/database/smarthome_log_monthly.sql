...
--
-- Table structure for table `log_monthly`
--

DROP TABLE IF EXISTS `log_monthly`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `log_monthly` (
  `home_id` char(3) NOT NULL,
  `meter_id` char(3) NOT NULL,
  `year` smallint(5) unsigned NOT NULL,
  `month` tinyint(4) NOT NULL,
  `accum` float NOT NULL,
  PRIMARY KEY (`home_id`,`meter_id`,`year`,`month`),
  KEY `by_year_idx` (`home_id`,`meter_id`,`year`)
...
-- Dump completed on 2014-10-05  9:37:35
